...
description: Reviews GitHub Actions CI/CD workflow YAML for security (OIDC auth, no inline secrets, approval gates), image tagging (commit SHA, not latest), deployment safety, and reusable workflow usage.
model: flash
tools:
  - view_file
  - grep_search
